...
final class ShellChromeProvider implements ShellChromeProviderInterface
{
    ...
    private function detectActiveSection(?string $activeId, string $path): string
    {
        ...
        if (str_contains($path, '/interfacing/launchpad') || str_contains($path, '/interfacing/screens') || str_contains($path, '/interfacing/operations') || str_contains($path, '/interfacing/tables') || str_contains($path, '/interfacing/forms') || str_contains($path, '/interfacing/affordances') || str_contains($path, '/interfacing/readiness') || str_contains($path, '/interfacing/obligations') || str_contains($path, '/interfacing/bridges') || str_contains($path, '/interfacing/promotions') || str_contains($path, '/interfacing/components') || str_contains($needle, 'admin.launchpad') || str_contains($needle, 'screen-directory') || str_contains($needle, 'operation.workbench') || str_contains($needle, 'admin.tables') || str_contains($needle, 'crud.frames') || str_contains($needle, 'crud.affordances') || str_contains($needle, 'crud.readiness') || str_contains($needle, 'component.obligations') || str_contains($needle, 'runtime.bridges') || str_contains($needle, 'promotion.gates') || str_contains($needle, 'component.roadmap')) {
            return 'screens';
        }
