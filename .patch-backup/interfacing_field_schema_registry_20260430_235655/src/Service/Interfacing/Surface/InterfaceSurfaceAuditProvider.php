...
final readonly class InterfaceSurfaceAuditProvider implements InterfaceSurfaceAuditProviderInterface
{
    ...
    private function shellItems(): array
    {
        return [
            ...
            new InterfaceSurfaceAuditItem('shell.component-obligations', 'Shell coverage', 'Component obligations', 'solid', '/interfacing/obligations', 'Shell-native checklist proving component-owned fixtures, contracts, runtime bridges and evidence remain outside Interfacing.'),
            new InterfaceSurfaceAuditItem('shell.runtime-bridges', 'Shell coverage', 'Runtime bridges', 'solid', '/interfacing/bridges', 'Shell-native route/controller/query/command bridge catalog for planned and connected components.'),
