...
final readonly class EcommerceScreenCatalogProvider implements EcommerceScreenCatalogProviderInterface
{
    ...
    private function platformEntries(): array
    {
        return [
            ...
            new EcommerceScreenEntry('platform.component-roadmap', 'Platform', 'Interfacing', 'Component roadmap', 'index', '/interfacing/components', 'connected', 'screen', 'Full Smart Responsor component roadmap and e-commerce screen obligations.'),
