...
final class ShellChromeProvider implements ShellChromeProviderInterface
{
    ...
    private function topLink(): array
    {
        return [
            ...
            new ShellNavItem('ecommerce.matrix', 'E-commerce Matrix', '/interfacing#ecommerce-screen-matrix', 'workspace', null, 40),
    ...
    private function detectActiveSection(?string $activeId, string $path): string
    {
        ...
        if (str_contains($path, '/interfacing/screens') || str_contains($path, '/interfacing/operations') || str_contains($needle, 'screen-directory') || str_contains($needle, 'operation.workbench')) {
            return 'screens';
        }
