...
- `ServiceInterface/Interfacing/Access/InterfaceScreenActionAccessResolverInterface.php` — request-aware access decisions for opening screens and running screen actions.
- `ServiceInterface/Interfacing/Access/InterfaceRoleAccessResolverInterface.php` — legacy role-list access check used by older screen-spec rendering paths.
- `ServiceInterface/Interfacing/Security/InterfaceScreenAccessResolverInterface.php` — screen-spec access check used by the action dispatcher and screen-aware security services.
- `ServiceInterface/Interfacing/Shell/InterfaceCapabilityAccessResolverInterface.php` — shell chrome capability check for navigation, layout, and panel visibility.
