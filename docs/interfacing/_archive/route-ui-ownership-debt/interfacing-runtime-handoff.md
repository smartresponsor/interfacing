# Interfacing runtime handoff

The Runtime Handoff screen (`/interfacing/runtime-handoff`) makes the handoff between Interfacing and owning Smart Responsor components explicit.
...
- handoff visibility and readiness reporting.
...
No business demo rows should be introduced in Interfacing to make a planned handoff look connected.
