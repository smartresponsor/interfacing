...
namespace App\Interfacing\Presentation\LiveComponent\Widget\Form;
...
#[AsLiveComponent('interfacing_widget_form', template: 'widget/form/form.html.twig')]
final class InterfaceFormWidgetComponent
{
    #[LiveProp]
    ...
    public function __construct(private readonly InterfaceFormHandlerRegistryInterface $registry)
    {
    }
