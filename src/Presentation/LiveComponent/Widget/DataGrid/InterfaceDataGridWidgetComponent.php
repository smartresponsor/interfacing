...
namespace App\Interfacing\Presentation\LiveComponent\Widget\DataGrid;
...
use App\Interfacing\ServiceInterface\LiveComponent\Widget\DataGrid\InterfaceDataGridWidgetComponentInterface;
use Symfony\UX\LiveComponent\Attribute\AsLiveComponent;
use Symfony\UX\LiveComponent\Attribute\LiveAction;
use Symfony\UX\LiveComponent\Attribute\LiveProp;

#[AsLiveComponent('interfacing_widget_data_grid', template: 'widget/data-grid/data-grid.html.twig')]
final class InterfaceDataGridWidgetComponent implements InterfaceDataGridWidgetComponentInterface
{
    #[LiveProp]
    ...
    public function __construct(
        private readonly InterfaceDataGridProviderRegistryInterface $registry,
        private readonly InterfaceBulkActionRegistryInterface $bulkRegistry,
    ) {
    }
    ...
    {
        $query = new InterfaceDataGridQuery(
            search: $this->search,
        ...
        if ([] !== $this->removedId) {
            ...
            $result = new InterfaceDataGridResult($row, $result->page(), $result->pageSize(), max(0, $result->total() - count($this->removedId)));
        }
    ...
    private function applyBulkResult(InterfaceBulkActionResult $result): void
    {
