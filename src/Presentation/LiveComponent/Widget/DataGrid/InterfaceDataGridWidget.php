...
use App\Interfacing\ServiceInterface\LiveComponent\Widget\DataGrid\InterfaceDataGridWidgetInterface;
...
final class InterfaceDataGridWidget implements InterfaceDataGridWidgetInterface
{
    #[LiveProp]
    ...
    public function __construct(private readonly InterfaceDataGridProviderRegistryInterface $registry)
    {
    }
    ...
    public function result(): InterfaceDataGridResult
    {
        ...
        if ($total > 0) {
            ...
            if ($this->pageIndex > $maxPageIndex) {
                ...
                $res = $provider->fetch(new InterfaceDataGridQuery(
                    search: $this->search,
                    sortKey: $this->sortKey ?? 'id',
                    sortDir: $this->sortDir,
                    page: max(1, $this->pageIndex + 1),
