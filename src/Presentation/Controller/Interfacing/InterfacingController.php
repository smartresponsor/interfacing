...
final class InterfacingController extends AbstractController
{
    public function __construct(
        ...
        private readonly EcommercePromotionGateProviderInterface $ecommercePromotionGateProvider,
        private readonly EcommerceEvidenceRegistryProviderInterface $ecommerceEvidenceRegistryProvider,
        private readonly EcommerceContractRegistryProviderInterface $ecommerceContractRegistryProvider,
        private readonly EcommerceFieldSchemaRegistryProviderInterface $ecommerceFieldSchemaRegistryProvider,
    ...
    public function index(): Response
    {
        return $this->renderer->render('interfacing/page/index.html.twig', [
            ...
            'promotionGateCounts' => $this->ecommercePromotionGateProvider->gateCounts(),
            'evidenceGradeCounts' => $this->ecommerceEvidenceRegistryProvider->gradeCounts(),
            'contractGradeCounts' => $this->ecommerceContractRegistryProvider->gradeCounts(),
            'fieldSchemaGradeCounts' => $this->ecommerceFieldSchemaRegistryProvider->gradeCounts(),
    ...
    {
        return $this->renderer->render('interfacing/page/evidence_registry.html.twig', [
            'title' => 'Interfacing evidence registry',
            'screenId' => 'evidence.registry',
            'evidenceGroups' => $this->ecommerceEvidenceRegistryProvider->groupedByZone(),
            'evidenceGradeCounts' => $this->ecommerceEvidenceRegistryProvider->gradeCounts(),
            'promotionGateCounts' => $this->ecommercePromotionGateProvider->gateCounts(),
            'runtimeBridgeGradeCounts' => $this->ecommerceRuntimeBridgeProvider->gradeCounts(),
        ]);
    ...
    {
        return $this->renderer->render('interfacing/page/contract_registry.html.twig', [
            'title' => 'Interfacing contract registry',
            'screenId' => 'contract.registry',
            'contractGroups' => $this->ecommerceContractRegistryProvider->groupedByZone(),
            'contractGradeCounts' => $this->ecommerceContractRegistryProvider->gradeCounts(),
            'evidenceGradeCounts' => $this->ecommerceEvidenceRegistryProvider->gradeCounts(),
            'promotionGateCounts' => $this->ecommercePromotionGateProvider->gateCounts(),
        ]);
    ...
    {
        return $this->renderer->render('interfacing/page/field_schema_registry.html.twig', [
            'title' => 'Interfacing field schema registry',
            'screenId' => 'field.schema.registry',
            'fieldSchemaGroups' => $this->ecommerceFieldSchemaRegistryProvider->groupedByZone(),
            'fieldSchemaGradeCounts' => $this->ecommerceFieldSchemaRegistryProvider->gradeCounts(),
            'contractGradeCounts' => $this->ecommerceContractRegistryProvider->gradeCounts(),
            'crudReadinessGradeCounts' => $this->ecommerceCrudReadinessProvider->gradeCounts(),
        ]);
    ...
    {
        return $this->renderer->render('interfacing/page/promotion_gates.html.twig', [
            'title' => 'Interfacing promotion gates',
            'screenId' => 'promotion.gates',
            'promotionGateGroups' => $this->ecommercePromotionGateProvider->groupedByZone(),
            'promotionGateCounts' => $this->ecommercePromotionGateProvider->gateCounts(),
            'runtimeBridgeGradeCounts' => $this->ecommerceRuntimeBridgeProvider->gradeCounts(),
        ]);
    }
