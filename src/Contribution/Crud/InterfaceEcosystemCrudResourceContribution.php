...
final class InterfaceEcosystemCrudResourceContribution extends InterfaceAbstractCrudResourceContribution implements InterfaceCrudResourceDescriptorContributionInterface
{
    public function provide(): array
    {
        return [
            ...
            $this->genericResource('integration.handoff', 'Integration', 'Handoff', 'integration-handoff', 'Planned canonical CRUD resource for integration handoff surfaces.'),
