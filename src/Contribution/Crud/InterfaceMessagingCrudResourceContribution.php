...
final class InterfaceMessagingCrudResourceContribution extends InterfaceAbstractCrudResourceContribution implements InterfaceCrudResourceDescriptorContributionInterface
{
    public function provide(): array
    {
        return [
            $this->canonicalResource('messaging.message', 'Messaging', 'Message', 'message', 'Generic CRUD path for message records complements custom inbox/room handoff screens.'),
            ...
            $this->canonicalResource('messaging.notification', 'Messaging', 'Notification', 'notification', 'Notification CRUD path complements the custom notification inbox handoff.'),
