...
final readonly class EcommerceComponentRoadmapProvider implements EcommerceComponentRoadmapProviderInterface
{
    ...
    private function rows(): array
    {
        return [
            ...
            $this->row('cataloging', 'Catalog and discovery', 'Cataloging', 'connected', '/catalog/category/', 'Cataloging owns catalog records and fixtures; Interfacing owns only chrome and CRUD links.', ['Products', 'Categories', 'Collections', 'Attributes', 'Media references', 'Catalog search preview'], ['product', 'category', 'collection', 'attribute', 'catalog-media']),
