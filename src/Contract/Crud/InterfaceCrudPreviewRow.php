...
/**
 * Neutral preview row for the generic CRUD workbench handoff.
 *
 * The generic Interfacing handoff must not depend on an order-specific DTO
 ...
 */
final readonly class InterfaceCrudPreviewRow
{
