...
final class InterfaceDemoDeleteBulkActionHandler implements InterfaceBulkActionHandlerInterface
{
    ...
    public function execute(array $id, array $context = []): InterfaceBulkActionResult
    {
        ...
        return new InterfaceBulkActionResult('Deleted '.$count.' item(s).', removedId: $id, updatedId: []);
    }
}
