    ...
    public function provide(): array
    {
        return [
            ...
            new InterfaceScreenSpec(
                ...
                'Notification inbox',
                new InterfaceLayoutScreenSpec(id: 'message.notifications.inbox', title: 'Notification inbox', routePath: 'screen/interfacing/showcase/message/notifications-inbox'),
                [],
                [],
            ...
            new InterfaceScreenSpec(
                ...
                'Search results',
                new InterfaceLayoutScreenSpec(id: 'message.search.results', title: 'Search results', routePath: 'screen/interfacing/showcase/message/search-results'),
                [],
                [],
            ...
            new InterfaceScreenSpec(
                ...
                'Rooms collection',
                new InterfaceLayoutScreenSpec(id: 'message.rooms.collection', title: 'Rooms collection', routePath: 'screen/interfacing/showcase/message/rooms-collection'),
                [],
                [],
