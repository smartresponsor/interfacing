 ...
 */
final readonly class InterfaceDemoProjectShowcaseProvider implements InterfaceProjectShowcaseProviderInterface
{
    public function provide(array $criteria = []): array
    {
        ...
        return [
            ...
            'route' => '/interfacing/showcase/project',
            'canonicalRoutes' => ['/interfacing/showcase/project'],
            'query' => $query,
    ...
    {
        return [
            ['id' => 'all', 'title' => 'All projects', 'url' => '/interfacing/showcase/project'],
            ['id' => 'top', 'title' => 'Top projects', 'url' => '/interfacing/showcase/project?section=top'],
            ['id' => 'implementation', 'title' => 'Implementation packs', 'url' => '/interfacing/showcase/project?section=implementation'],
            ['id' => 'automation', 'title' => 'Automation projects', 'url' => '/interfacing/showcase/project?section=automation'],
            ['id' => 'strategy', 'title' => 'Strategy projects', 'url' => '/interfacing/showcase/project?section=strategy'],
        ];
    }
    ...
    private function cards(): array
    {
        return [
            ...
            [
                ...
                'title' => 'Smart Responsoring Engine',
                'eyebrow' => 'Intellectual product',
                'category' => 'Smart Responsoring',
            ...
            [
                'id' => 'project-integration-handoff',
                'title' => 'Integration Handoff Pack',
                'eyebrow' => 'Implementation project',
                'category' => 'Handoff integration',
                ...
                'accent' => 'Handoff',
                'visual' => 'Handoff pack',
                'href' => '#project-integration-handoff',
                'tags' => ['Accessing', 'Interfacing', 'Handoff'],
