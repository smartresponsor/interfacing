...
use App\Interfacing\ProviderInterface\Ecommerce\InterfaceEcommerceContractRegistryProviderInterface;
use App\Interfacing\ProviderInterface\Ecommerce\InterfaceEcommerceFieldSchemaRegistryProviderInterface;

final readonly class InterfaceEcommerceFieldSchemaRegistryProvider implements InterfaceEcommerceFieldSchemaRegistryProviderInterface
{
    public function __construct(private InterfaceEcommerceContractRegistryProviderInterface $contractRegistryProvider)
    {
    }
    ...
    public function provide(): array
    {
        ...
        foreach ($this->contractRegistryProvider->provide() as $contract) {
            if (!$contract instanceof InterfaceEcommerceContractItem) {
                continue;
            }

            $items[] = new InterfaceEcommerceFieldSchemaItem(
        ...
        usort(
            $items,
            static fn (InterfaceEcommerceFieldSchemaItem $left, InterfaceEcommerceFieldSchemaItem $right): int => [
    ...
    /** @return list<string> */
    private function identifierContracts(InterfaceEcommerceContractItem $contract): array
    {
    ...
    /** @return list<string> */
    private function tableColumns(InterfaceEcommerceContractItem $contract): array
    {
        return match ($contract->contractGrade()) {
    ...
    /** @return list<string> */
    private function formFields(InterfaceEcommerceContractItem $contract): array
    {
        return match ($contract->contractGrade()) {
    ...
    /** @return list<string> */
    private function validationRules(InterfaceEcommerceContractItem $contract): array
    {
        return match ($contract->contractGrade()) {
    ...
    /** @return list<string> */
    private function relationshipFields(InterfaceEcommerceContractItem $contract): array
    {
        return match ($contract->contractGrade()) {
    ...
    /** @return list<string> */
    private function openQuestions(InterfaceEcommerceContractItem $contract): array
    {
        return match ($contract->contractGrade()) {
    ...
    private function note(InterfaceEcommerceContractItem $contract): string
    {
        return sprintf(
