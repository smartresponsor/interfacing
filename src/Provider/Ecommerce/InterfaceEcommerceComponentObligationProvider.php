...
use App\Interfacing\ProviderInterface\Ecommerce\InterfaceEcommerceComponentObligationProviderInterface;
use App\Interfacing\ProviderInterface\Ecommerce\InterfaceEcommerceComponentRoadmapProviderInterface;

final readonly class InterfaceEcommerceComponentObligationProvider implements InterfaceEcommerceComponentObligationProviderInterface
{
    ...
    public function provide(): array
    {
        ...
        foreach ($this->roadmapProvider->provide() as $roadmap) {
            ...
            $items[] = new InterfaceEcommerceComponentObligationItem(
        ...
        usort(
            $items,
            static fn (InterfaceEcommerceComponentObligationItem $left, InterfaceEcommerceComponentObligationItem $right): int => [
    ...
    /** @return list<string> */
    private function fixtureObligations(InterfaceEcommerceComponentRoadmapItem $roadmap): array
    {
    ...
    /** @return list<string> */
    private function contractObligations(InterfaceEcommerceComponentRoadmapItem $roadmap): array
    {
        return [
    ...
    /** @return list<string> */
    private function runtimeObligations(InterfaceEcommerceComponentRoadmapItem $roadmap): array
    {
        return [
            'controller/handoff routes matching the canonical CRUD grammar',
    ...
    /** @return list<string> */
    private function evidenceObligations(InterfaceEcommerceComponentRoadmapItem $roadmap): array
    {
        return [
