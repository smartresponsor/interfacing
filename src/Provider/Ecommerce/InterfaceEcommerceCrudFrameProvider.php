...
use App\Interfacing\ProviderInterface\Ecommerce\InterfaceEcommerceCrudFrameProviderInterface;

final readonly class InterfaceEcommerceCrudFrameProvider implements InterfaceEcommerceCrudFrameProviderInterface
{
    ...
    private function newFrame(InterfaceEcommerceAdminTableRow $row): InterfaceEcommerceCrudFrame
    {
        return new InterfaceEcommerceCrudFrame(
            id: $row->id().'.new.frame',
            zone: $row->zone(),
    ...
    private function editFrame(InterfaceEcommerceAdminTableRow $row): InterfaceEcommerceCrudFrame
    {
        return new InterfaceEcommerceCrudFrame(
    ...
    private function deleteFrame(InterfaceEcommerceAdminTableRow $row): InterfaceEcommerceCrudFrame
    {
        return new InterfaceEcommerceCrudFrame(
