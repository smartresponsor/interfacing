...
use App\Interfacing\ProviderInterface\Ecommerce\InterfaceEcommerceCrudAffordanceProviderInterface;

final readonly class InterfaceEcommerceCrudAffordanceProvider implements InterfaceEcommerceCrudAffordanceProviderInterface
{
    public function __construct(private InterfaceEcommerceAdminTableProviderInterface $adminTableProvider)
    {
    }
    ...
    public function provide(): array
    {
        ...
        foreach ($this->adminTableProvider->provide() as $row) {
            if (!$row instanceof InterfaceEcommerceAdminTableRow) {
                continue;
            }
    ...
    private function filterAffordance(InterfaceEcommerceAdminTableRow $row): InterfaceEcommerceCrudAffordance
    {
        return new InterfaceEcommerceCrudAffordance(
    ...
    private function sortAffordance(InterfaceEcommerceAdminTableRow $row): InterfaceEcommerceCrudAffordance
    {
        return new InterfaceEcommerceCrudAffordance(
    ...
    private function bulkAffordance(InterfaceEcommerceAdminTableRow $row): InterfaceEcommerceCrudAffordance
    {
        return new InterfaceEcommerceCrudAffordance(
