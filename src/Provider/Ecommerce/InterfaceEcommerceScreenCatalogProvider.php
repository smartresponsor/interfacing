...
final readonly class InterfaceEcommerceScreenCatalogProvider implements InterfaceEcommerceScreenCatalogProviderInterface
{
    ...
    private function platformEntries(): array
    {
        return [
            ...
            new InterfaceEcommerceScreenEntry('platform.component-obligations', 'Platform', 'Interfacing', 'Component obligations', 'index', '/interfacing/obligations', 'connected', 'screen', 'Owning-component checklist for fixtures, contracts, runtime handoff and evidence without Interfacing-owned business rows.'),
            new InterfaceEcommerceScreenEntry('platform.runtime-handoff', 'Platform', 'Interfacing', 'Runtime handoff', 'index', '/interfacing/runtime-handoff', 'connected', 'screen', 'Runtime handoff catalog for route/controller/query/command/policy/evidence supplied by owning components.'),
            ...
            new InterfaceEcommerceScreenEntry('platform.component-roadmap', 'Platform', 'Interfacing', 'Component roadmap', 'index', '/interfacing/components', 'connected', 'screen', 'Full Smart Responsor component roadmap and e-commerce screen obligations.'),
            new InterfaceEcommerceScreenEntry('platform.crud-explorer', 'Platform', 'Interfacing', 'CRUD Explorer', 'index', '/interfacing/resource/explorer', 'connected', 'screen', 'Canonical index of CRUD route grammar across Smart Responsor.'),
            new InterfaceEcommerceScreenEntry('platform.doctor', 'Platform', 'Interfacing', 'Doctor', 'index', '/interfacing/doctor/page', 'connected', 'screen', 'Operator diagnostics surface.'),
    ...
    /** @return list<InterfaceEcommerceScreenEntry> */
    private function crudOperationEntries(InterfaceCrudResourceLinkSetInterface $resource): array
    {
        ...
        return [
            ...
            new InterfaceEcommerceScreenEntry($baseId.'.new', $zone, $component, $label, 'new', $resource->newUrl(), $status, 'crud', 'New form route follows the canonical CRUD handoff.'),
