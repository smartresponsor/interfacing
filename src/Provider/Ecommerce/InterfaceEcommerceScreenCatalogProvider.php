...
final readonly class InterfaceEcommerceScreenCatalogProvider implements InterfaceEcommerceScreenCatalogProviderInterface
{
    ...
    private function platformEntries(): array
    {
        return [
            ...
            new InterfaceEcommerceScreenEntry('platform.crud-explorer', 'Platform', 'Interfacing', 'CRUD Explorer', 'index', '/interfacing/crud/explorer', 'connected', 'screen', 'Canonical index of CRUD route grammar across Smart Responsor.'),
