...
final readonly class InterfaceEcommerceComponentRoadmapProvider implements InterfaceEcommerceComponentRoadmapProviderInterface
{
    public function provide(): array
    {
        ...
        foreach ($this->rows() as $row) {
            $items[] = new InterfaceEcommerceComponentRoadmapItem(
                id: $row['id'],
                zone: $row['zone'],
        ...
        usort(
            $items,
            static fn (InterfaceEcommerceComponentRoadmapItem $left, InterfaceEcommerceComponentRoadmapItem $right): int => [
    ...
    private function rows(): array
    {
        return [
            ...
            $this->row('cataloging', 'Catalog and discovery', 'Cataloging', 'connected', '/interfacing/showcase/catalog/category', 'Cataloging owns catalog records and fixtures; Interfacing owns only chrome and CRUD links.', ['Products', 'Categories', 'Collections', 'Attributes', 'Media references', 'Catalog search preview'], ['product', 'category', 'collection', 'attribute', 'catalog-media']),
            ...
            $this->row('complying', 'Tax and governance', 'Complying', 'planned', '/interfacing/surface/compliance-rule/', 'Complying owns policy/compliance checks and obligations.', ['Compliance rules', 'Compliance checks', 'Obligations'], ['compliance-rule', 'compliance-check', 'obligation']),
            ...
            $this->row('messaging', 'Messaging', 'Messaging', 'connected', '/interfacing/showcase/message/', 'Messaging owns rooms, threads, messages and notification fixtures.', ['Notifications inbox', 'Rooms', 'Threads', 'Messages', 'Digests', 'Templates'], ['message', 'room', 'thread', 'digest', 'message-template']),
            ...
            $this->row('integration-handoff', 'Platform operations', 'Integration handoff', 'planned', '/integration-handoff/', 'Integration handoff owns external-system connection maps without reintroducing a generic connection surface.', ['Handoff maps', 'External links', 'Integration health'], ['integration-handoff', 'handoff-mapping', 'integration-health']),
            ...
            $this->row('projecting', 'Platform operations', 'Projecting', 'planned', '/interfacing/showcase/projection/', 'Projecting owns projections and read-model update state.', ['Projections', 'Projection runs', 'Read model state'], ['projection', 'projection-run', 'read-model-state']),
