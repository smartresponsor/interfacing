...
final readonly class InterfaceShellScreenCatalogProvider implements InterfaceShellScreenCatalogProviderInterface
{
    ...
    public function catalog(?string $activeId = null): array
    {
        ...
        return [
            ...
            'contract' => [
                'purpose' => 'Single screen catalog for shell pages, CRUD handoff pages, diagnostics, exports and known Smart Responsor application resources.',
                'crudLinkRule' => 'CRUD entries use the same handoff URL grammar exposed by InterfaceCrudResourceExplorerProvider.',
