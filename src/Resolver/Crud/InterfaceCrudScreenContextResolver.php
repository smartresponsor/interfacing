...
final readonly class InterfaceCrudScreenContextResolver
{
    public function resolve(Request $request, InterfaceCrudRouteContext $routeContext): InterfaceCrudScreenContext
    {
        ...
        return new InterfaceCrudScreenContext(
    ...
    private function defaultTemplateIntent(InterfaceCrudRouteContext $routeContext): string
    {
    ...
    private function defaultAccessMode(InterfaceCrudRouteContext $routeContext): string
    {
        return match (true) {
    ...
    private function defaultReadonly(InterfaceCrudRouteContext $routeContext): bool
    {
        return 'show' === $routeContext->operation || ('delete' === $routeContext->operation && $routeContext->isPublicSurface());
    }

    private function defaultMutationAllowed(InterfaceCrudRouteContext $routeContext, bool $readonly): bool
    {
        if ($readonly) {
            return false;
        }
    ...
    private function defaultCapabilityLabel(InterfaceCrudRouteContext $routeContext, string $accessMode): string
    {
    ...
    private function defaultOwnershipLabel(InterfaceCrudRouteContext $routeContext): string
    {
    ...
    private function routeUrl(Request $request, InterfaceCrudRouteContext $routeContext, string $operation): string
    {
