...
final class InterfaceAttributeTagCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        foreach ($container->getDefinitions() as $definition) {
            ...
            foreach ($ref->getAttributes(InterfaceAsScreen::class) as $attr) {
            ...
            foreach ($ref->getAttributes(InterfaceAsAction::class) as $attr) {
                $meta = $attr->newInstance();
