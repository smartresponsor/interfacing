...
final class InterfaceDemoSaveProfileActionEndpoint implements InterfaceActionEndpointInterface
{
    ...
    public function handle(InterfaceActionRequest $request): InterfaceActionResult
    {
        ...
        if ([] !== $fieldError) {
            return InterfaceActionResult::validationError($fieldError, $globalError);
        }
        ...
        return InterfaceActionResult::ok($statePatch, [
